...
public class ParkingSpaceManagementDO  implements Serializable {
    ...
    @Column(name = "surname",columnDefinition = "varchar(50) comment '姓名'")
    private String surname;

    @Column(name = "id_number",columnDefinition = "varchar(50) comment '身份证号'")
    private String idNumber;

    @Column(name = "mobile_phone",columnDefinition = "varchar(50) comment '客户电话'")
