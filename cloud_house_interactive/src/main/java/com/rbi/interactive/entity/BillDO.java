...
//    private Double preferentialTotalAmount;
    ...
    @Column(name = "toll_collector_name",columnDefinition = "varchar(50) comment '收费人编号，当前收费客户人员的姓名'")
...
//    private String orderGenerationDate;
    ...
    @Column(name = "cost_involved",columnDefinition = "varchar(200) comment '涉及费用：物业费、车位租赁费、车位管理费'")
    private String costInvolved;

    @Column(name = "offset_original_doc_no",columnDefinition = "varchar(50) comment '抵扣原单据号'")
    private String offsetOriginalDocNo;
