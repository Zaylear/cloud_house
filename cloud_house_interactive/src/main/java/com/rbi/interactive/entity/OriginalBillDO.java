...
@Entity
@Table(name = "original_bill")
@Data
public class OriginalBillDO implements Serializable {
    ...
    @Column(name = "actual_money_collection",columnDefinition = "float(0) comment '实收金额'",scale = 2)
    private Double actualMoneyCollection;

    @Column(name = "preferential_amount",columnDefinition = "float(0) comment '优惠金额'",scale = 2)
    ...
    @Column(name = "balance_amount",columnDefinition = "float(8,2) comment '优惠券抵扣金额'")
    private Float balanceAmount;

    @Column(name = "surplus_money",columnDefinition = "float(8,2) comment '余额抵扣金额'",scale = 2)
